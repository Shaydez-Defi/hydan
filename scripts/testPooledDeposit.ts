...
const VAULT_ABI = parseAbi([
  "function deposit(uint256 assets, address receiver) external returns (bytes32 shares)",
  "function withdraw(uint256 assets, address receiver, address owner) external returns (bytes32 shares)",
